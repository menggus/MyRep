...
class UserInfo(RbacUserInfo):
    ...
    员工表
    """
    tname = models.CharField(verbose_name='真实姓名', max_length=16, default=None)
...
class ClassList(models.Model):
    ...
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',
                              null=True, blank=True, on_delete=models.SET_NULL, limit_choices_to={"depart_id": 1})
...
class ConsultRecord(models.Model):
    ...
    客户跟进记录
    """
    customer = models.ForeignKey(verbose_name="所咨询客户", to='Customer', blank=True, null=True, on_delete=models.SET_NULL)
    consultant = models.ForeignKey(verbose_name="跟踪人", to='UserInfo', blank=True, null=True, on_delete=models.SET_NULL)
...
class PaymentRecord(models.Model):
    ...
    缴费记录
    """
    customer = models.ForeignKey(Customer, verbose_name="客户", blank=True, null=True, on_delete=models.SET_NULL)
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', help_text="谁签的单就选谁", blank=True, null=True, on_delete=models.SET_NULL)
    class_list = models.ForeignKey(verbose_name="分配班级", to="ClassList", null=True, blank=True, on_delete=models.SET_NULL)
    class_list = models.ForeignKey(verbose_name="分配班级", to="ClassList", null=True, blank=True, on_delete=models.SET_NULL)
    pay_type_choices = [
        (1, "报名费"),
        (2, "学费"),
    ...
    confirm_user = models.ForeignKey(verbose_name="确认人", to='UserInfo', related_name='confirms', null=True, blank=True, on_delete=models.SET_NULL)
...
class Student(models.Model):
    ...
    学生表（已报名）
    """
    customer = models.OneToOneField(verbose_name='客户信息', to='Customer', blank=True, null=True, on_delete=models.SET_NULL)
...
class ChangeClass(models.Model):
    ...
    转班记录
    """
    origin_class = models.ForeignKey(verbose_name="原班级", to="ClassList", related_name='x1', blank=True, null=True, on_delete=models.SET_NULL)
    target_class = models.ForeignKey(verbose_name="目标班级", to="ClassList", related_name='x2', blank=True, null=True, on_delete=models.SET_NULL)
    memo = models.TextField(verbose_name='原因')
    user = models.ForeignKey(verbose_name='处理人', to='UserInfo', blank=True, null=True, on_delete=models.SET_NULL)
...
class StudyRecord(models.Model):
    course_record = models.ForeignKey(verbose_name="第几天课程", to="CourseRecord", blank=True, null=True,on_delete=models.SET_NULL)
    student = models.ForeignKey(verbose_name="学员", to='Student', blank=True, null=True, on_delete=models.SET_NULL)
    record_choices = (
        ('checked', "已签到"),
        ('vacate', "请假"),
        ('late', "迟到"),
