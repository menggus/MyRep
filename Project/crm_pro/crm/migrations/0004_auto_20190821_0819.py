# Generated by Django 2.1.1 on 2019-08-21 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.UserInfo', verbose_name='跟踪人')),
            ],
        ),
        migrations.CreateModel(
            name='CourseRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultant', to='crm.UserInfo', verbose_name='课程顾问')),
                ('course', models.ManyToManyField(to='crm.Course', verbose_name='咨询课程')),
                ('referral_from', models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部学员姓名', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='internal_referral', to='crm.Customer', verbose_name='转介绍自学员')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.CourseRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.Student', verbose_name='学员')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='student',
            name='customer',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.Customer', verbose_name='客户信息'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='class_list',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.ClassList', verbose_name='分配班级'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='confirm_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='confirms', to='crm.UserInfo', verbose_name='确认人'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='consultant',
            field=models.ForeignKey(blank=True, help_text='谁签的单就选谁', null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.Customer', verbose_name='客户'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='class_obj',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.ClassList', verbose_name='班级'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.UserInfo', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.Customer', verbose_name='所咨询客户'),
        ),
        migrations.AddField(
            model_name='changeclass',
            name='origin_class',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='x1', to='crm.ClassList', verbose_name='原班级'),
        ),
        migrations.AddField(
            model_name='changeclass',
            name='target_class',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='x2', to='crm.ClassList', verbose_name='目标班级'),
        ),
        migrations.AddField(
            model_name='changeclass',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='crm.UserInfo', verbose_name='处理人'),
        ),
    ]
